...
mysql$kubectl exec -it mysql-8b749c7c8-qmfw2 -n expense -- mysql -h mysql -u root -pExpenseApp@1


backend$ kubectl exec -it backend-sgfdsmredgs  -n expense -- bash
opt/server/$ apk add mysql-client
